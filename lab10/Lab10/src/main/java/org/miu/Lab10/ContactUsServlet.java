...
public class ContactUsServlet extends HttpServlet {
	...
	private void sendResponse(HttpServletResponse response) throws IOException {
		...
		String html = "<!DOCTYPE html>\r\n" + 
				...
				"                                <input class=\"form-control\" type=\"text\" name=\"fullName\" id=\"fullName\" placeholder=\"Full Name\" required autofocus>\r\n" + 
				...
				"                                    <input required type=\"radio\" name=\"radioGender\" id=\"radioradioGenderMale\" class=\"custom-control-input\" value=\"Male\" checked>\r\n" + 
				"                                    <label for=\"radioradioGenderMale\" class=\"custom-control-label\">Male</label>\r\n" + 
				"                                </div>\r\n" + 
				"                                <div class=\"custom-control custom-radio custom-control-inline\">\r\n" + 
				"                                    <input required type=\"radio\" name=\"radioGender\" id=\"radioradioGenderFemale\" class=\"custom-control-input\" value=\"Female\">\r\n" + 
